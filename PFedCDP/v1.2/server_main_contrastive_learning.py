...
def perform_multi_teacher_distillation():
    ...
    teacher_model_A = keras.models.load_model("Model_A_server_model-round-10.h5")
    teacher_model_B = keras.models.load_model("Model_B_server_model-round-10.h5")
    teacher_models = [teacher_model_A, teacher_model_B]
    
    # Rest of the distillation process remains the same...
