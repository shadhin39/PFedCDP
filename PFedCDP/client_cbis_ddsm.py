# client_cbis_ddsm.py
# Federated Learning Client for CBIS-DDSM Dataset
import argparse
...
# Parse arguments
parser = argparse.ArgumentParser(description="Flower CBIS-DDSM Client")
parser.add_argument(
    "--partition-id",
    type=int,
    ...
    "The dataset is divided into 50 partitions.",
)
...
def partition_data(x_data, y_data, partition_id, num_partitions=50):
    """Partition data for federated learning"""
...
x_train, y_train = partition_data(x_train_full, y_train_full, args.partition_id, 50)
...
class CBISFlowerClient(NumPyClient):
...
def client_fn(cid: str):
    """Create and return an instance of Flower Client for CBIS-DDSM."""
    return CBISFlowerClient()

# Legacy mode
if __name__ == "__main__":
    print(f"Starting CBIS-DDSM client {args.partition_id}...")
    start_numpy_client(
        server_address="127.0.0.1:8080",
        client=CBISFlowerClient(),
